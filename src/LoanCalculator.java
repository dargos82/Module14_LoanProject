...
/** class LoanCalculator contains the objects, variables, and methods needed to create a simple
 * calculator using JFrame as a GUI.  The user provides 3 variables that are used to produce
 * the outputs.
...
public class LoanCalculator extends JFrame
{
   ...
   /**
    * LoanCalculator() creates the frame.
    * 
    * @param txtInterestRate
    * @param txtNumberOfYears
    * @param txtLoanAmount
    * @param txtMonthlyPayment
    * @param txtTotalPayment
    * 
    */
   public LoanCalculator()
   {
      ...
      btnCalculate.addActionListener(new ActionListener()
      {
         ...
         /**
          * actionPerformed() contains logic to calculate the outputs from the inputs when the button
          * is selected.
          * 
          * @param interestRate
          * @param months
